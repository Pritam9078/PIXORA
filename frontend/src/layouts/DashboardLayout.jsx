...
const DashboardLayout = ({ children, role = 'Student', navigation = [] }) => {
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                <p className="text-[10px] font-bold text-white uppercase tracking-wider">Learner Name</p>
                <p className="text-[9px] text-secondary-container uppercase tracking-widest font-medium">{role}</p>
              </div>
